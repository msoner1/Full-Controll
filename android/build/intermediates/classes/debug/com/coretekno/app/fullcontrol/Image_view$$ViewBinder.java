...
public class Image_view$$ViewBinder<T extends com.coretekno.app.fullcontrol.Image_view> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558567, "field 'image' and method 'image_click'");
    target.image = finder.castView(view, 2131558567, "field 'image'");
    ...
    view = finder.findRequiredView(source, 2131558566, "field 'pc_image'");
    target.pc_image = finder.castView(view, 2131558566, "field 'pc_image'");
    ...
    view = finder.findRequiredView(source, 2131558568, "method 'download_image'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
